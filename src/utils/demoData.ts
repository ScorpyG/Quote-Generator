...
// These functions generate fake data to help test/develop the UI components
...
export function generateTestData(): Array<QuoteProps> {
  ...
  for (let i = 1; i <= 50; i++) {
    const demoData: QuoteProps = {
      quote:
        i % 2 === 0
          ? `${i}. Hello World! This is a test string. 
            This absolutely has no meaning. Its only purpose 
            is to display some texts`
